...
MACRO(TRIBITS_REPOSITORY_DEFINE_PACKAGING)
  ...
  #MESSAGE("TRIBITS_REPOSITORY_DEFINE_PACKAGING() called for Taurus!")

  GET_FILENAME_COMPONENT(Taurus_SOURCE_PATH ${Taurus_SOURCE_DIR} PATH)
  ...
  FOREACH(TRIBITS_PACKAGE ${NON_ENABLED_PACKAGES})
    ...
    IF("${IS_RELATIVE_PATH}" STREQUAL "")
      SET(CPACK_SOURCE_IGNORE_FILES ${Taurus_SOURCE_PATH}/${PACKAGE_DIR} ${CPACK_SOURCE_IGNORE_FILES})
    ELSE()
      FIND_PATH(ABSOLUTE_PATH CMakeLists.txt PATHS ${Taurus_SOURCE_PATH}/${PACKAGE_DIR} NO_DEFAULT_PATH)
  ...
  MACRO(COPY_INSTALLER_RESOURCE _varname _source _destination)
    ...
    CONFIGURE_FILE(
      ...
      COPYONLY)
  ENDMACRO()
  COPY_INSTALLER_RESOURCE(Taurus_README
    "${Taurus_SOURCE_DIR}/README.md"
    "${Taurus_BINARY_DIR}/README.md")
  COPY_INSTALLER_RESOURCE(Taurus_LICENSE
    "${Taurus_SOURCE_DIR}/LICENSE"
    "${Taurus_BINARY_DIR}/LICENSE.txt")

  SET(CPACK_PACKAGE_DESCRIPTION "Taurus provides algorithms and technologies for the solution of large-scale, complex multi-physics engineering and scientific problems.")
  SET(CPACK_PACKAGE_FILE_NAME "Taurus-setup-${Taurus_VERSION}")
  SET(CPACK_PACKAGE_INSTALL_DIRECTORY "Taurus ${Taurus_VERSION}")
  SET(CPACK_PACKAGE_REGISTRY_KEY "Taurus ${Taurus_VERSION}")
  SET(CPACK_PACKAGE_NAME "Taurus")
  SET(CPACK_PACKAGE_VENDOR "EPFL - CMCS, MOX Polimi, INRIA REO, ESTIME, Sc. Comp. Emory Univ.")
  SET(CPACK_PACKAGE_VERSION "${Taurus_VERSION}")
  SET(CPACK_RESOURCE_FILE_README "${Taurus_README}")
  SET(CPACK_RESOURCE_FILE_LICENSE "${Taurus_LICENSE}")
  SET(CPACK_SOURCE_GENERATOR "TGZ;TBZ2")
  SET(CPACK_SOURCE_FILE_NAME "Taurus-source-${Taurus_VERSION}")
  SET(CPACK_COMPONENTS_ALL ${Taurus_PACKAGES} Unspecified)
  
  set(ENABLED_FLAG ON)
  set(INCLUDE_EMPTY FALSE)
  TRIBITS_GET_ENABLED_LIST( Taurus_PACKAGES Taurus ${ENABLED_FLAG}
