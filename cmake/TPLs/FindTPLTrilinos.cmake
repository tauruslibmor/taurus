...
foreach (TYPE IN ITEMS "OPTIONAL" "REQUIRED")
  foreach (PKG IN LISTS Taurus_${TYPE}_Trilinos_PKGS)
    # Look for PKG
    ...
    if (PKG_FOUND GREATER -1)
      ...
      list (APPEND Taurus_Trilinos_LIBRARIES "${${PKG}_LIBRARIES}")
      list (APPEND Taurus_Trilinos_TPL_INCLUDE_DIRS "${${PKG}_TPL_INCLUDE_DIRS}")
      list (APPEND Taurus_Trilinos_TPL_LIST "${${PKG}_TPL_LIST}")
...
# Cleaning duplicates
list (REVERSE Taurus_Trilinos_TPL_LIST)
list (REMOVE_DUPLICATES Taurus_Trilinos_TPL_LIST)
list (REVERSE Taurus_Trilinos_TPL_LIST)
list (REVERSE Taurus_Trilinos_LIBRARIES)
list (REMOVE_DUPLICATES Taurus_Trilinos_LIBRARIES)
list (REVERSE Taurus_Trilinos_LIBRARIES)
list (REVERSE Trilinos_TPL_LIBRARIES)
list (REMOVE_DUPLICATES Trilinos_TPL_LIBRARIES)
list (REVERSE Trilinos_TPL_LIBRARIES)
set (Taurus_Trilinos_TPL_LIBRARIES ${Trilinos_TPL_LIBRARIES})

list (REMOVE_DUPLICATES Taurus_Trilinos_TPL_INCLUDE_DIRS)

list (APPEND Taurus_Trilinos_INCLUDE_DIRS
  ${Trilinos_INCLUDE_DIRS}
  ${Taurus_Trilinos_TPL_INCLUDE_DIRS})
# I think there's a better way to handle this ... CMake
# should take care of -L or -l or -rpath ...
set (Taurus_Trilinos_LIBS "-L${Trilinos_LIBRARY_DIRS}")
foreach (LIB IN LISTS Taurus_Trilinos_LIBRARIES)
  set (Taurus_Trilinos_LIBS "${Taurus_Trilinos_LIBS} -l${LIB}")
endforeach (LIB)
set (Taurus_Trilinos_LIBS ${Taurus_Trilinos_LIBS} ${Taurus_Trilinos_TPL_LIBRARIES})

# TPLs
foreach (TPL IN ITEMS "ParMETIS" "Boost" "LAPACK" "BLAS" "UMFPACK" "SuperLU" "SuperLUDist" "HDF5")
    list (FIND Taurus_Trilinos_TPL_LIST ${TPL} TPL_FOUND)
...
set (TPL_Trilinos_INCLUDE_DIRS ${Taurus_Trilinos_INCLUDE_DIRS})
set (TPL_Trilinos_LIBRARY_DIRS ${Trilinos_LIBRARY_DIRS})
set (TPL_Trilinos_LIBRARIES ${Taurus_Trilinos_LIBS})
